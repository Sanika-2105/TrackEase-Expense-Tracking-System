...
<head>
    ...
    <title>TrackEase-Delete Expense confirmation</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    PreparedStatement pstmt=con.prepareStatement("select * from expense where expense_id=?");
    pstmt.setInt(1, expid);
    ResultSet rs=pstmt.executeQuery();
    %>
    <main class="main-content">
        <div class="expense-container">
            <h2 class="expense-table-title">Delete Expense</h2>
            ...
            <table class="expense-table">
                ...
                <div class="delete-buttons">
                <a href="deleteExpense.jsp?expid=<%=rs.getInt(1)%>" class="delete-btn">Delete</a>
                <a href="ViewExpense.jsp" class="cancel-btn">Cancel</a>
            </div>
                <%} %>
            </table>
